...
def cmdline_args():
    ...
    parser.add_argument('--dif_decoder', type=str, choices=['att', 'mlp', 'mamba', 'mamba_tcond', 'mamba_tcond_ssm', 'mamba_tcond_ffn', 'mamba_tcond_input', 'spc_mamba_nogate', 'spc_mamba', 'mamba_adaln_only', 'mamba_tcond_input_adaln', 'mamba_tcond_input_adaln_localattn_last', 'mamba_tcond_input_adaln_localattn_all', 'mamba_tcond_input_adaln_stage_route_m', 'mamba_tcond_input_adaln_stage_route_f', 'mamba_tcond_input_adaln_stage_route_both', 'mamba_tcond_input_adaln_ffn_stage_adapter', 'mamba_tcond_input_adaln_ffn_tsm_adapter', 'mamba_tcond_input_adaln_ffn_tsm_adapter_noglobal'], help='Choose denoised decoder')
